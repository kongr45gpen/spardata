          ...
          <section class="flex flex-col p-4 w-full max-w-md flex-none bg-gray-100 min-h-0 overflow-auto">
            ...
            <ul>
              <li>
                <article
                  tabindex="0"
                  class="cursor-pointer border rounded-md p-3 bg-white flex items-center text-gray-700 mb-2 hover:border-green-500 focus:outline-none focus:border-green-500"
                >
                  ...
                  <span class="text-stone-400">LEO</span>
                </article>
              </li>
              <li>
                <article
                ...
                >
                  ...
                  <header class="ml-1 font-semibold text-md grow">
                    Structures
                  </header>
                  <span class="" />
                </article>
              ...
              <li>
                ...
                >
                  <span class="flex-none pt-1 pr-2">
                    <!-- <img class="h-8 w-8 rounded-md" src="https://raw.githubusercontent.com/bluebrown/tailwind-zendesk-clone/master/public/assets/avatar.png" /> -->
                    <div class="h-8 w-8 rounded-md bg-slate-600 border-slate-400 flex items-center justify-center">
                      <ChevronRightIcon fill-color="white" />
                    </div>
                  </span>
                  <header class="ml-1 font-semibold text-md grow">
                    Communications
                ...
                <ul class="ml-10">
                  <li>
                    ...
                    >
                      ...
                      <span class="text-stone-400">SateLite 240-AJH</span>
                    </article>
                  </li>
                  <li>
                    <article
                      tabindex="0"
                      class="cursor-pointer border rounded-md p-3 bg-blue-100 flex items-center text-gray-700 mb-2 hover:border-green-500 focus:outline-none border-blue-500"
                    >
                      <span class="flex-none pt-1 pr-2">
                        <!-- <img class="h-8 w-8 rounded-md" src="https://raw.githubusercontent.com/bluebrown/tailwind-zendesk-clone/master/public/assets/avatar.png" /> -->
                        <div class="h-8 w-8 rounded-md bg-gray-400 flex items-center justify-center">
                      ...
                      <span class="text-stone-400">NXP 880-SUBGHZ</span>
                    </article>
                  </li>
                  <li>
                    <article
                    ...
                    >
                      ...
                      <span class="text-stone-400">STM32F104R8T6</span>
                    </article>
                  </li>
                </ul>
              </li><li>
          ...
          <section aria-label="main content" class="flex min-h-0 flex-col flex-auto border-l">
                  ...
                  <ul class="flex items-center">
                    <li class="inline-flex items-center">
                      <a href="#" class="text-gray-600 hover:text-blue-500 align-baseline">
                        ...
                        <svg
                          class="w-5 h-auto fill-current mx-2 text-gray-400 align-baseline"
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          fill="#000000"
                        >
            ...
            <div class="mx-auto rounded-lg shadow-lg w-full lg:flex">
              <div class="py-8 px-6 text-center lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12">
                <img class="w-60" src="/img/antenna.png">
              </div>
              <div class="flex-1 bg-gray-50 px-6 py-8 lg:p-12">
                ...
                <div class="mt-8">
                  ...
                  <div class="mt-3 text-sm">
                    <p>The transceiver includes a PA.</p>
                    <p class="mt-1">
                ...
                <div class="mt-8">
                  ...
                  <div class="flex mt-4 gap-5">
                    <a
                      class="px-6 py-2 min-w-[120px] text-center text-white bg-indigo-800 border border-indigo-700 rounded flex justify-center items-center h-50"
                      href=""
                    >
                      <div class="mt-1">
                        <LinkVariantIcon />
              ...
              <tbody class="flex w-full flex-col min-h-0 overflow-hidden px-4">
                ...
                <tr role="row" class="hover:bg-blue-100 border-b flex cursor-pointer">
                  ...
                  <td class="py-3 px-1 w-48">
                    ...
                    <span class="ml-2 font-bold">Frequency</span>
                  </td>
                ...
                <tr role="row" class="hover:bg-blue-100 border-b flex cursor-pointer">
                  ...
                  <td class="py-3 px-1 w-48">
                    ...
                    <span class="ml-2 font-bold">Bandwidth</span>
                  </td>
                  <td class="py-3 px-1 flex-1">
                    <div class="relative group w-full">
                      <p class="w-full truncate font-mono">
                ...
                <tr role="row" class="hover:bg-blue-100 border-b flex cursor-pointer">
                  ...
                  <td class="py-3 px-1 w-48">
                    ...
                    <span class="ml-2 font-bold">Modulation</span>
                  </td>
                  <td class="py-3 px-1 flex-1">
                    <div class="relative group w-full">
                      <p class="w-full truncate font-mono">
                ...
                <tr role="row" class="hover:bg-blue-100 border-b flex cursor-pointer">
                  ...
                  <td class="py-3 px-1 w-48">
                    ...
                    <span class="ml-2 font-bold">Data Rate</span>
                  </td>
                  <td class="py-3 px-1 flex-1">
                    <div class="relative group w-full">
                      <p class="w-full truncate font-mono">
                        512 kbps
                        <CodeBlockBracesIcon class="inline-block mr-2 align-top" />
                      </p>
                    </div>
                  </td>
                  <td class="py-3 px-1 mr-2 truncate">
                ...
                <tr role="row" class="hover:bg-blue-100 border-b flex cursor-pointer">
                  ...
                  <td class="py-3 px-1 w-48 truncate">
                    ...
                    <span class="ml-2 font-bold">Power Consumption</span>
                  </td>
                  <td class="py-3 px-1">
                    <div class="relative group w-full">
                      <p class="w-full truncate font-mono">
                  ...
                  <td class="py-3 px-1 pl-5 flex-1">
                    <!-- Source: https://codepen.io/fnando/pen/KyZLLV -->
                    <svg class="sparkline sparkline--blue sparkline--filled" width="100" height="30" stroke-width="3">
                      <path
                        class="sparkline--fill"
                        d="M4 5 L 4 5 L 8.842105263157894 5 L 13.68421052631579 5 L 18.526315789473685 5 L 23.36842105263158 5 L 28.210526315789473 25 L 33.05263157894737 25 L 37.89473684210526 25 L 42.73684210526316 25 L 47.578947368421055 5 L 52.421052631578945 5 L 57.26315789473684 5 L 62.10526315789474 5 L 66.94736842105263 5 L 71.78947368421052 5 L 76.63157894736842 25 L 81.47368421052632 25 L 86.3157894736842 25 L 91.15789473684211 25 L 96 5 V 30 L 4 30 Z"
                        stroke="none"
                      />
                      <path
